 ...
 * @author Pranav
 */
public class ViewPersonPage1 extends javax.swing.JFrame {

    /**
     * Creates new form ViewPatientPage
     */
    PersonHistory perhistory;
    public ViewPersonPage1(PersonHistory perhistory) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPersonPage1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPersonPage1(perhistory).setVisible(true);
            }
        });
    }

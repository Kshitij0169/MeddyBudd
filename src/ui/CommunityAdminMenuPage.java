 ...
 * @author Pranav
 */
public class CommunityAdminMenuPage extends javax.swing.JFrame {

    /**
     * Creates new form MenuPage
     */
    PersonHistory perhistory ;
    public CommunityAdminMenuPage( PersonHistory perhistory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Community-Admin Menu ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CommunityAdminMenuPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CommunityAdminMenuPage(perhistory).setVisible(true);
            }
        });
    }

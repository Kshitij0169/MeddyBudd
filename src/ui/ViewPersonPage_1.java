 ...
 * @author Pranav
 */
public class ViewPersonPage extends javax.swing.JFrame {

    /**
     * Creates new form ViewPatientPage
     */
    PersonHistory perhistory;
    public ViewPersonPage(PersonHistory perhistory) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPersonPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPersonPage(perhistory).setVisible(true);
            }
        });
    }
